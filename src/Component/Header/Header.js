...
export const Header = () => {
  ...
  return (
    <section className="fixed h-full z-50">
      <div className={changebackground ? 'sidebar alternate-background' : 'sidebar'}>
        ...
        <div className="item">
          <svg className="icon"data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <div className="text" onClick={() => {navigate ("/");setchangebackground(false)}}>Home</div>
        </div>
        <hr />
        {
          userLoggedIn ? (
            <>
              <div className="item">
                ...
                }
                {
                  auth?.currentUser?.displayName? (
                    ...
                    <div className="text">{auth.currentUser.email}</div>
                  )
                }              
              </div>
              ...
              <div className="item">
                ...
                <div className="text" onClick={() => doSignOut()}>Logout</div>
              </div>
            </>
          ):(
              <>
                  <div className="item">
                    ...
                    <div className="text" onClick={() => {navigate("/login");setchangebackground(true)}}>Login</div>
                  </div>
                  <div className="item">
                    <svg className="icon"data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Zm6-10.125a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm1.294 6.336a6.721 6.721 0 0 1-3.17.789 6.721 6.721 0 0 1-3.168-.789 3.376 3.376 0 0 1 6.338 0Z"></path>
                    </svg>
                    <div className="text" onClick={() => {navigate("/register");setchangebackground(true)}}>Sign up</div>
                  </div>
              </>
          )
        }
        <div className="item">
          ...
          <div onClick={() => navigate("/comment")} href="/comment" className="text">Comment</div>
        </div>
        <div className="item">
          <svg className="icon" data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      {
        close ? (
          <div className="nav-button" onClick={() => setclose(false)}>
            <svg className="bg-green-400 w-11 rounded-full icon"data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"></path>
            </svg>
          </div>
        ):(
        <div className={changebackground ? 'sidebar2 alternate-background' : 'sidebar2'}>
          <div className='logo'>
              <img src={images.logo} alt="" />
            </div>
            ...
            <div className="item">
                ...
                <div onClick={() => {navigate ("/");setclose(true);setchangebackground(false) }} className="text">Home</div>
            </div>
            <hr />
            {
              userLoggedIn ? (
                <>
                  ...
                  <div className="item">
                    ...
                    <div onClick={() => doSignOut()} className="text" >Logout</div>
                  </div>
                </>
              ):(
                  <>
                      <div className="item">
                        ...
                        <div onClick={() => {navigate("/login");setclose(true);setchangebackground(true)}} className="text">Login</div>
                      </div>
                      <div className="item">
                        <svg className="icon"data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Zm6-10.125a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm1.294 6.336a6.721 6.721 0 0 1-3.17.789 6.721 6.721 0 0 1-3.168-.789 3.376 3.376 0 0 1 6.338 0Z"></path>
                        </svg>
                        <div onClick={() => {navigate("/register");setclose(true);setchangebackground(true)}} className="text">Sign up</div>
                      </div>
                  </>
              )
            }
            <div className="item">
              ...
              <div onClick={() => {navigate("/comment");setclose(true)}} className="text">Comment</div>
            </div>
            <div className="item">
              <svg className="icon" data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" d="m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z"></path>
              </svg>              
              <div className="text" onClick={() => {setclose(true)}}>About</div>
            </div>
          </div>
        )
      }         
