        ...
        <div className='comment-container pt-20 pb-5'>
            <form onSubmit={(e) => {e.preventDefault();sendcomment()}} id='enter-comment' className='bg-yellow-100' action="#">
                ...
                <div className='flex w-auto'>
                    ...
                    <textarea className='rounded-lg focus:outline-none focus:ring-0' id="form-input" rows="4" placeholder={cartItemsString? "Hãy điền comment của bạn(1 lần gửi)" : "Bạn cần mua hàng để comment(mỗi lần)"} onChange={(e)=> setusercomment(e.target.value)}></textarea>
                </div>
