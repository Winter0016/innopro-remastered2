...
import { CartItem2 } from './cart-item2';
    ...
    <>
          ...
          <div className={changebackground ? 'sidecart2 alternate-background' : 'sidecart2'}>
              <div className='si-item'>
                ...
                <div id='cartposition' className='si-item-text'>Cart</div>
              </div> 
              ...
              </div>
              {
                totalAmount > 0 ? (
                  <div className=' finish-container'>
                    <div className='bg-green-500 rounded-lg mb-2 si-info-name'> Total: {totalAmount.toLocaleString("en-US")} VND</div>
