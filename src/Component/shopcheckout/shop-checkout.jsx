  ...
  return (
    <>
        <div className='checkout-show'>
          ...
          <form id='form-checkout' className=' max-w-3xl m-auto rounded-lg overflow-auto pb-3 pt-3' action="#" onSubmit={(e) => {
            e.preventDefault();
            submitorder();
            }}>
            <div className=' overflow-hidden'>
              <div className='flex flex-wrap overflow-hidden pl-4 mt-2 checkout-submit'>
                <div className='flex w-auto overflow-hidden rounded-md border-2'>
                ...
                <div className='flex w-auto overflow-hidden rounded-md border-2'>
                  ...
                  <input id='form-input' className=" w-72 focus:outline-none focus:ring-0"type="text"placeholder='Số ĐT' required value={userphone} onChange={(e) => setuserphone(e.target.value)}/>
                </div>          
              </div>
              <div className='flex flex-wrap overflow-hidden pl-4 mt-2  checkout-submit'>
                <div className='flex w-auto overflow-hidden rounded-md border-2'>
                  ...
                  <input id='form-input' className="w-80 focus:outline-none focus:ring-0"type="text"placeholder='Địa Chỉ' value={useraddress} onChange={(e) => setuseraddress(e.target.value)} required />
                </div> 
                <div className='flex w-auto overflow-hidden rounded-md border-2'>
                  <div id='icon-container' className='pt-1'>
                    <svg  className="icon"data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
