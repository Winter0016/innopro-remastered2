...
export const Login = () => {
    ...
    return (
        <div>
            ...
            <main className="flex justify-center items-center h-screen border-4 bg-gray-900">
                <div className="w-full max-w-md p-8 bg-gray-300 rounded shadow-xl">
                    <h2 className="text-center text-2xl font-semibold text-gray-800 mb-4">Welcome Back</h2>
                    ...
                    <p className="text-center text-sm mt-4">Don't have an account? <Link to={'/register'} className="text-indigo-600 font-semibold hover:underline">Sign up</Link></p>
