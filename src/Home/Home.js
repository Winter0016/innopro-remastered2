            ...
            <>
                <div className={speaktosale ? "speaktosale" : "speaktosale inactive"}>
                    <div class="mx-auto w-full h-full max-w-screen-xl flex flex-col md:justify-center relative">
                        ...
                        <div class="flex flex-wrap gap-48 items-center">
                            <img id='callcenter' src={images.callcenter} alt="" />
                            <div>
                                <h2 class="mb-6 font-semibold text-gray-900 uppercase dark:text-white text-4xl">Contract</h2>
                                <ul class="text-gray-500 dark:text-gray-400 font-medium text-4xl">
                                    <li class="mb-4">
                                        <a class="hover:underline">HOTLINE: 0906970475</a>
                                    </li>
                                    <li class="mb-4">
